...
<style scoped>
    ...
    .goods-spec-info .spec-right .goods-price { height: 20px; line-height: 20px; }
    .goods-spec-info .spec-right .goods-unit { line-height: 20px; }
    .goods-spec-info .spec-right .goods-unit dl dd a { display: inline-block; border: 1px solid #b9b9b9; margin: 0 5px 5px 0; color: #000; background-color: #fff; text-align: center; height: 20px; padding: 0 5px; text-decoration: none; }
            ...
            <div class="goods-spec-info">
                ...
                <div class="spec-right">
                    ...
                    <dl class="goods-price">
                        <dt>增减价</dt>
                        <dd>￥{{ spec_detail.goods_floatingprice > 0 ? '+' + spec_detail.goods_floatingprice : spec_detail.goods_floatingprice }}</dd>
                    </dl>
